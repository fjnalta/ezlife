...
const userHandler = new (require('./userHandler'))();
...
router.get('/login', handleCookies.setCookieState, function (req, res) {
...
router.post('/login', handleGoogleApi.verifyToken, userHandler.login, function (req, res) {
    res.redirect('/', {
        data : config.runtime
    });
});
